...
public abstract class Animal {
    ...
    /*
        ...
        3) "Concrete methods" focus on "How to do", "Abstract methods" focus on "What to do"
        ...
        8)You can both "concrete methods" and "abstract methods" in "abstract classes"
        ...
        10)An "abstract class" cannot be "final" because; final class cannot have child classes but abstract class should have child classes
           to make "abstract methods" to be implemented in child classes.
        ...
        12)"abstract classes" are classes, so they have "constructor" like other classes but the constructor cannot create object.
