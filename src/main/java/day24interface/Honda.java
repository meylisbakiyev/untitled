...
public class Honda implements Ac, Engine{
    ...
    /*
        ...
        3)Multiple inheritance is not supported for classes, if you use "inheritance" as parents Java will
        ...
        7)To make an "Interface" parent of a "Concrete Class" use "implements" keyword instead of "extends"
          To make an "Interface" parent of a "Abstract Class" use "implements" keyword instead of "extends"
        ...
        9)Interfaces do not have "constructors" that is why you cannot create object from an interface.
          As you remember, we cannot create object from "abstract class" as well.
          But "abstract classes" have constructors, the constructor cannot create object.
