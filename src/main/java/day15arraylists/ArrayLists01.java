...
public class ArrayLists01 {
    public static void main(String[] args) {
        ...
        //If you put an integer into remove() method paranthesis, Java accepts the integer as "primitive int", if the number you put
        //inside remove() method paranthesis is "primitive int", it will be index.
