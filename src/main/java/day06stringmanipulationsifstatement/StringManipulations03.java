...
public class StringManipulations03 {
    public static void main(String[] args) {
        //Ex 1: Type code to check if given String contains a specific character or characters
        //      "New York" ==> w --> true     -    Yorl --> true    -  Xxx --> false
        String s="New York";
        ...
        //Ex 2: Type code to change the first ocurence of "java" to "python"
        ...
        //Ex 3: Type code to repeat a given String
