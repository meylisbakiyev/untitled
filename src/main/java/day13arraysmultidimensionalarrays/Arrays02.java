...
public class Arrays02 {
    public static void main(String[] args) {
        ...
        //2.Way: Use binarySearch() method tells you if the elements exists or not in the array
        //       To use binarySearch() method, you have to use sort() first

        Arrays.sort(ch);

        //binarySearch() method gives yoiu index of existing element after sorting
