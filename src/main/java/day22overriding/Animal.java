...
public class Animal {
    ...
    /*
        ...
        2) We can not touch "Method Signature"(Method Name and Method Parameters) in "Method Overriding"
        ...
        5) Return Type of the Overridden Method can be "top return type" of the Overriding Method
        ...
        7) Between the "Wrapper Classes" there is no "parent-child relationship" that is why you cannot have "IS-A" relationship
           If you do not have "IS-A" relationship you can not change return type in "Method Overriding"

        8) Between the "primitive data types" there is no "parent-child relationship" that is why you cannot have "IS-A" relationship
           If you do not have "IS-A" relationship you can not change return type in "Method Overriding"

        9) If the return type is void you can not change it in method overriding

        10) "private" methods in "parent class" can not be overridden
