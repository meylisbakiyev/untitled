...
public class NestedIfStatement01 {
    /*
        Nested Structures use too much time in execution, it makes the application slow that is why we don't like to use
        nested structure, but sometines it is being mandatory to  use, that is why we are learning.
    ...
    public static void main(String[] args) {
        ...
        //Ex1: If the worker is male and the age is greater than 65 he will be retired otherwise he should work
