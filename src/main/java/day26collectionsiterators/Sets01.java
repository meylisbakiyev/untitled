...
public class Sets01 {
    ...
    public static void main(String[] args) {
        ...
        /*
            You have all products set, you have discounted products list
            You want to see discounted products in the all products set

            all product set ==> TV. Radio, Fridge, Watch, Laptop
        ...
        /*
            Interview Question: What do you store unique elements in natural order?
                                Answer: TreeSet
