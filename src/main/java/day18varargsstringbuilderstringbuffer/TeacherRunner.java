...
public class TeacherRunner {
    public static void main(String[] args) {
        ...
        //If you are in a different package "default" variables will be "inaccessible"
        //If you are in a different package and the class you created the objects not the  "child class" variables
