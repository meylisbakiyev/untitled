...
public class LinkedList01 {
         /*
            1)Removing operation needs too many tasks for Java,
              that is why f we need too much removing operation
              we do not prefer to use ArrayLists
            2)Adding elements/s into an ArrayList makes Java reindex,
            ...
            8)If you create a functionality to add and remove museum visitors in an app, use "LinkedList"
              ...
              ArrayList is successful in "search" operation but not successful in "adding" amd "removing" operations
         */
    ...
    public static void main(String[] args) {
        ...
        //Returns "rue" if this list contained the specified element
